        ...
        if (Session["Proyectos"] == null)
        {
            var proyectos = new List<Proyecto>
            {
                new Proyecto
                {
                    ...
                    {
                        new Integrante { Nombre = "Alber Apaza", Rol = Rol.LiderDeProyecto },
                        new Integrante { Nombre = "Ricardo Cutipa", Rol = Rol.Desarrollador }
                    }
                },
                new Proyecto
                {
                    ...
                    Integrantes = new List<Integrante>
                    {
                        new Integrante { Nombre = "Carlos Escobar", Rol = Rol.ProjectOwner },
                        new Integrante { Nombre = "Jesus Huallpa", Rol = Rol.Desarrollador }
                    }
                }
            };
